...
API_ID = int(environ.get('API_ID', '10756969'))
API_HASH = environ.get('API_HASH', 'cd6eef261797436a6fe2b7cbf1630320')
BOT_TOKEN = environ.get('BOT_TOKEN', "5797499618:AAFD4xCRgMCKxxoRrkKwIw1h74cHkSngOO4")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 3600))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))

PICS = (environ.get('PICS', 'https://telegra.ph/file/33b0ed76884a7caf41dc1.jpg')).split()
NOR_IMG = environ.get("NOR_IMG", "https://telegra.ph/file/33b0ed76884a7caf41dc1.jpg")
SPELL_IMG = environ.get("SPELL_IMG", "https://telegra.ph/file/33b0ed76884a7caf41dc1.jpg")
NEWGRP = environ.get("NEWGRP", "https://telegra.ph/file/33b0ed76884a7caf41dc1.jpg")

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1952325083').split()]
...
DATABASE_NAME = environ.get('DATABASE_NAME', "Akpicture")
...
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', '0c7f8cf3816e3e624c92a1f3eed94579906f01ae')
